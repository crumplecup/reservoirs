...
fn main() {
    ...
    let mut stereo = fluvial
        .capture_rate_gravels(0.29) // Set capture rate for gravels in flux from the Kolmogorov-Smirnov test.
        .storage_rate_gravels(0.34) // Set storage rate for gravels in storage from the Kolmogorov-Smirnov test.
